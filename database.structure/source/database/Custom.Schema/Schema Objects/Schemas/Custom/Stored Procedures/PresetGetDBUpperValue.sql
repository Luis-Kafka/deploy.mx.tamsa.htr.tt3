CREATE PROCEDURE [Custom].[PresetGetDBUpperValue]
...
BEGIN
	...
	--	SELECT CONVERT(FLOAT, Specification.FsGetBatchSpecificationAttribute(@idBatchHistory, 'BC_WO_COMMON','PRESSURE.PROCESS_MIN', NULL, NULL, NULL)) + 500 As [Value]
