...
BEGIN TRY
    ...
    EXEC [Shift].[DoConfigDefineShiftCrewProfile] @ShiftProfileCrewProfileShiftProfileCode = 'STD8H', @ShiftProfileCrewProfileCrewProfileCode = '6X2', @AreaCode = 'TT3', @MachineWorkflowCode = 'ALL', @Code = 'TT3', @Name = 'TT3', @Description = 'TT3', @IsInUse = True, @Active = True;
