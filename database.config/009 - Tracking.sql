...
BEGIN TRY
    ...
    EXEC [Tracking].[DoConfigDefineZone] @AreaCode = 'TT3', @DefaultOutOfLineZoneCode = null, @CommandCode = null, @Code = 'Crane', @PlcCode = 1, @Name = 'Crane', @Description = 'Crane', @MaxItems = 150, @IsWB = False, @IsAutoWrap = True, @IsOutOfLine = True, @AllowBasicEdition = True, @Active = True;
    EXEC [Tracking].[DoConfigDefineZone] @AreaCode = 'TT3', @DefaultOutOfLineZoneCode = null, @CommandCode = null, @Code = 'DeadZone', @PlcCode = 2, @Name = 'DeadZone', @Description = 'DeadZone', @MaxItems = 25, @IsWB = False, @IsAutoWrap = True, @IsOutOfLine = True, @AllowBasicEdition = True, @Active = True;
