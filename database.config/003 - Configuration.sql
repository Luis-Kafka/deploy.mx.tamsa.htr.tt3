...
BEGIN TRY
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'Acquisition', @Name = 'Acquisition', @Description = 'Acquisition used by Command Manager', @Data = '<AcquisitionConfiguration factoryType="Tenaris.Library.IAcquisition.Wedjet.AcquisitionFactory, Tenaris.Library.IAcquisition.Wedjet">
		<WedjetConfiguration wedjetNetSource="tcp://127.0.0.1:49100"/>
...
<AlarmConfiguration pollingEnabled="False" pollingTime="0" TestMode="False" AcquisitionFactoryName="Acquisition"/>
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'AlarmMgr.Local', @Name = 'Tenaris.Manager.Alarm.AlarmManager.Local', @Description = 'Alarm Manager Local Proxy', @Data = '<Tenaris.Manager.Alarm.AlarmManager.Proxy url="tcp://localhost:49111/Tenaris.Manager.Alarm.AlarmManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'AlarmMgr.Proxy', @Name = 'Tenaris.Manager.Alarm.AlarmManager.Proxy', @Description = 'Alarm Manager Proxy', @Data = '<Tenaris.Manager.Alarm.AlarmManager.Proxy url="tcp://127.0.0.1:49111/Tenaris.Manager.Alarm.AlarmManager.soap"
		instanceType="Tenaris.Manager.Alarm.Shared.IAlarmManager, Tenaris.Manager.Alarm.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
  		<Redundancy>
   			<Address url="tcp://127.0.0.1:49111/Tenaris.Manager.Alarm.AlarmManager.soap" forumPresent="false" isTargetManager="true"/>
  		</Redundancy>
</Tenaris.Manager.Alarm.AlarmManager.Proxy>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'AlarmView', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'AlarmView', @Name = 'CustomViewConfiguration', @Description = 'Alarm Manager View', @Data = '  <CustomViewConfiguration IsEnableAck="true"
  						   LocalGroupCode="PROD"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'AlarmView', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'AlarmView.Plg1', @Name = 'AlarmViewGridConfiguration', @Description = 'Grid Configuration', @Data = '  <GridViewConfiguration>
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'CommandHistory', @Name = 'Tenaris.Manager.Command.CommandHistory', @Description = 'Command History Factory Configuration', @Data = '<Tenaris.Manager.Command.CommandHistory factoryType="Tenaris.Manager.Command.CommandHistoryFactory, Tenaris.Manager.Command" isSingleton="True">
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'CommandMgr', @Name = 'Tenaris.Manager.Command.CommandManager', @Description = 'Command Manager Factory Configuration', @Data = '<Tenaris.Manager.Command.CommandManager factoryType="Tenaris.Manager.Command.CommandManagerFactory, Tenaris.Manager.Command" isSingleton="True">
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'CommandMgr.Local', @Name = 'Tenaris.Manager.Command.CommandManager.Local', @Description = 'Command Manager Local Proxy', @Data = '<Tenaris.Manager.Command.CommandManager.Proxy url="tcp://localhost:49104/Tenaris.Manager.Command.CommandManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'CommandMgr.Proxy', @Name = 'Tenaris.Manager.Command.CommandManager.Proxy', @Description = 'Command Manager Proxy', @Data = '<Tenaris.Manager.Command.CommandManager.Proxy url="tcp://127.0.0.1:49104/Tenaris.Manager.Command.CommandManager.soap"
		instanceType="Tenaris.Manager.Command.Shared.ICommandManager, Tenaris.Manager.Command.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
    	<Redundancy>
     		 <Address url="tcp://127.0.0.1:49104/Tenaris.Manager.Command.CommandManager.soap" forumPresent="false" isTargetManager="true"/>
    	</Redundancy>
</Tenaris.Manager.Command.CommandManager.Proxy >', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'TrackingView', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'ConfigSource', @Name = 'ConfigSource', @Description = 'Tracking View ConfigSource', @Data = '<ConfigSource ConfigInDB="True"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'DiagnosticManager.Local', @Name = 'Tenaris.Manager.Diagnostic.DiagnosticManager.Local', @Description = 'Diagnostic Manager Local Proxy', @Data = '<Tenaris.Manager.Diagnostic url="tcp://localhost:49112/Tenaris.Manager.Diagnostic.DiagnosticManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'DiagnosticManager.Proxy', @Name = 'Tenaris.Manager.Diagnostic.DiagnosticManager.Proxy', @Description = 'Diagnostic Manager Proxy', @Data = '<Tenaris.Manager.Diagnostic url="tcp://127.0.0.1:49112/Tenaris.Manager.Diagnostic.DiagnosticManager.soap"
		instanceType="Tenaris.Manager.Diagnostic.Shared.IDiagnosticManager, Tenaris.Manager.Diagnostic.Shared" 
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
    	<Redundancy>
      		<Address url="tcp://127.0.0.1:49112/Tenaris.Manager.Diagnostic.DiagnosticManager.soap" forumPresent="false" isTargetManager="true"/>
    	</Redundancy>
</Tenaris.Manager.Diagnostic>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'TrackingView', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'DynamicHeaderConfiguration', @Name = 'DynamicHeaderConfiguration', @Description = 'DynamicHeaderConfiguration', @Data = '<DynamicHeaderConfiguration SpecificationServiceSectionName="SpecificationServiceClient.Proxy" />', @TypeName = 'Tenaris.View.Tracking.DynamicHeader.Configuration.DynamicHeaderConfiguration, Tenaris.View.Tracking.DynamicHeader', @Active = True;
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'HandshakeMgr', @Name = 'Tenaris.Manager.Handshake.HandshakeManager', @Description = 'Handshake Manager Factory Configuration', @Data = '<Tenaris.Manager.Handshake.HandshakeManager factoryType="Tenaris.Manager.Handshake.HandshakeFactory, Tenaris.Manager.Handshake" isSingleton="True">
...
<!-- ProcessingRetryCount - If greater than 0, configures how many retries are allowed before restaring the worker thread that processes a handshake.
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'HandshakeMgr.Local', @Name = 'Tenaris.Manager.Handshake.HandshakeManager.Local', @Description = 'Handshake Manager Local Proxy', @Data = '<Tenaris.Manager.Handshake.HandshakeManager url="tcp://localhost:49106/Tenaris.Manager.Handshake.HandshakeManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'HandshakeMgr.Proxy', @Name = 'Tenaris.Manager.Handshake.HandshakeManager.Proxy', @Description = 'Handshake Manager Proxy', @Data = '<Tenaris.Manager.Handshake.HandshakeManager url="tcp://127.0.0.1:49106/Tenaris.Manager.Handshake.HandshakeManager.soap"
		instanceType="Tenaris.Manager.Handshake.Shared.IHandshakeManager, Tenaris.Manager.Handshake.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
		<Redundancy>		
			<Address url="tcp://127.0.0.1:49106/Tenaris.Manager.Handshake.HandshakeManager.soap" forumPresent="false" isTargetManager="true"/>
		</Redundancy>
</Tenaris.Manager.Handshake.HandshakeManager>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'InterruptionManager', @Name = 'Tenaris.Manager.Interruption.InterruptionManager', @Description = 'Interruption Manager Factory Configuration', @Data = '<Tenaris.Manager.Interruption.InterruptionManager factoryType="Tenaris.Manager.Interruption.InterruptionManagerFactory, Tenaris.Manager.Interruption" isSingleton="True">
  <InterruptionManagerConfiguration keyManagerSectionName="Tenaris.Manager.Key.KeyManager.Local">
    <ActivePlugins>
      <Plugin machineCode="Entry" sectionName="InterruptionMgr.Plugin.Entry" type="Tenaris.Manager.Interruption.Plugin.Pipes.StatelessPipesPlugin, Tenaris.Manager.Interruption.Plugin.Pipes" />
    </ActivePlugins>
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'InterruptionManager.Local', @Name = 'Tenaris.Manager.Interruption.Local', @Description = 'Interruption Manager Local Proxy', @Data = '<Tenaris.Manager.Interruption.InterruptionManager.Proxy url="tcp://localhost:49109/Tenaris.Manager.Interruption.InterruptionManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'InterruptionManager.Proxy', @Name = 'Tenaris.Manager.Interruption.Proxy', @Description = 'Interruption Manager Proxy', @Data = '<Tenaris.Manager.Interruption.InterruptionManager.Proxy url="tcp://127.0.0.1:49109/Tenaris.Manager.Interruption.InterruptionManager.soap"
		instanceType="Tenaris.Manager.Interruption.Shared.IInterruptionManager, Tenaris.Manager.Interruption.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
		<Redundancy>
			<Address url="tcp://127.0.0.1:49109/Tenaris.Manager.Interruption.InterruptionManager.soap" forumPresent="false" isTargetManager="true"/>
		</Redundancy>
</Tenaris.Manager.Interruption.InterruptionManager.Proxy>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'InterruptionMgr.Plugin.Entry', @Name = 'InterruptionMgr.Plugin.Entry', @Description = 'Interruption Manager - Plugin Pipes Configuration', @Data = '<Interruption.Plugin.Pipes
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'InterruptionPluginPipes', @Name = 'Interruption.Plugin.Pipes', @Description = 'Interruption Manager - Plugin Pipes Configuration', @Data = '<Interruption.Plugin.Pipes
    ConnectionStringName="dbLevel2"
    HandlingMode="Production"
    ProductionManagerSectionName="Tenaris.Manager.Production.ProductionManager.Local"
    HandshakeManagerSectionName="Tenaris.Manager.Handshake.HandshakeManager.Local"
    ...
    SpecificationCadenceFieldName="CYCLETIME"
    CheckMissingInterruptionsAtStart="true"/>', @TypeName = 'Tenaris.Manager.Interruption.Plugin.Pipes.PipesPluginConfiguration, Tenaris.Manager.Interruption.Plugin.Pipes', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'InterruptionView', @AreaCode = 'TT3', @ZoneCode = 'ALL', @MachineCode = null, @Code = 'InterruptionView', @Name = 'CustomViewConfiguration', @Description = 'Interruption Manager View', @Data = '<CustomViewConfiguration 
                               PathExcelFiles="./Xls/"
                               MaxShiftDisplay="1"
            ...
            <Configuration>
                <ReportConfiguration showDialogWindow="true">
                    <PdfReportConfiguration
                        ...
                        sharedFolderPath="\\127.0.0.1\TenarisLog"
                        print="false"
...
', @TypeName = 'Tenaris.View.Interruption.Shared.Configuration.InterruptionViewConfigurationSection, Tenaris.View.Interruption.Shared', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'KeyMgr.Local', @Name = 'Tenaris.Manager.Key.KeyManager.Local', @Description = 'Key Manager Local Proxy', @Data = '<KeyManagerConfiguration.Proxy url="tcp://localhost:49108/Tenaris.Manager.Production.ProductionManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'KeyMgr.Proxy', @Name = 'Tenaris.Manager.Key.KeyManager.Proxy', @Description = 'Key Manager Proxy', @Data = '<KeyManagerConfiguration.Proxy url="tcp://127.0.0.1:49108/Tenaris.Manager.Production.ProductionManager.soap"
	instanceType="Tenaris.Library.IKeyManager.Shared.IKeyManager, Tenaris.Library.IKeyManager.Shared"
    aliveInterval="1000"
    singleInstance="true"
	isSingleton="true" 
    ...
    validateConnection="false">
    <Redundancy>	  
      <Address url="tcp://127.0.0.1:49108/Tenaris.Manager.Production.ProductionManager.soap" forumPresent="false" isTargetManager="true"/>
    </Redundancy>
</KeyManagerConfiguration.Proxy >', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'MgrBaseConfig', @Name = 'ManagerBaseConfiguration', @Description = 'ManagerBaseConfiguration', @Data = '<ManagerBaseConfiguration areaCode="TT3"  defaultConnectionStringName="dbLevel2" defaultCommandTimeout="10"/>', @TypeName = 'Tenaris.Manager.Forum.Shared.Configuration.ManagerBaseConfiguration, Tenaris.Manager.Forum.Shared', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'PlcMgr', @Name = 'Tenaris.Manager.PLC.PLCManager', @Description = 'Plc Manager Factory Configuration', @Data = '<Tenaris.Manager.PLC.PLCManager factoryType="Tenaris.Manager.PLC.PLCManagerFactory, Tenaris.Manager.PLC" isSingleton="True">
	<PLCManagerConfiguration wedjetConnectionStringName="dbLevel2" area="TT3"  />
...
', @TypeName = null, @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'PresetMgr', @Name = 'Tenaris.Manager.Preset.PresetManager', @Description = 'Preset Manager Factory Configuration', @Data = '<Tenaris.Manager.Preset.PresetManager factoryType="Tenaris.Manager.Preset.PresetManagerFactory, Tenaris.Manager.Preset" isSingleton="True">
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'PresetMgr.Local', @Name = 'Tenaris.Manager.Preset.PresetManager.Local', @Description = 'Preset Manager Local Proxy', @Data = '<Tenaris.Manager.Preset.PresetManager url="tcp://localhost:49110/Tenaris.Manager.Preset.PresetManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'FORGE', @ZoneCode = null, @MachineCode = null, @Code = 'PresetMgr.Proxy', @Name = 'Tenaris.Manager.Preset.PresetManager.Proxy', @Description = 'Preset Manager Proxy', @Data = '<Tenaris.Manager.Preset.PresetManager url="tcp://10.200.120.191:49110/Tenaris.Manager.Preset.PresetManager.soap"
        ...
        validateConnection="false">
		<Redundancy>
  			<Address url="tcp://127.0.0.1:49110/Tenaris.Manager.Preset.PresetManager.soap" forumPresent="false" isTargetManager="true"/>
		</Redundancy>
</Tenaris.Manager.Preset.PresetManager>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
...
<!-- BalancePluginType                          - Plugin to determine balance -->
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'ProductionMgr.Local', @Name = 'Tenaris.Manager.Production.ProductionManager.Local', @Description = 'Production Manager Local Proxy', @Data = '<Tenaris.Manager.Production.ProductionManager url="tcp://localhost:49108/Tenaris.Manager.Production.ProductionManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'ProductionMgr.Proxy', @Name = 'Tenaris.Manager.Production.ProductionManager.Proxy', @Description = 'Production Manager Proxy', @Data = '<Tenaris.Manager.Production.ProductionManager url="tcp://127.0.0.1:49108/Tenaris.Manager.Production.ProductionManager.soap"
		instanceType="Tenaris.Manager.Production.Shared.IProductionManager, Tenaris.Manager.Production.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'ProductionView', @AreaCode = 'TT3', @ZoneCode = 'ALL', @MachineCode = null, @Code = 'ProductionView', @Name = 'CustomViewConfiguration', @Description = 'Production View', @Data = '<CustomViewConfiguration 
...
', @TypeName = 'Tenaris.View.Production.Model.Common.ProductionViewConfiguration, Tenaris.View.Production.Model', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'ShiftMgr', @Name = 'Tenaris.Manager.Shift.ShiftManager', @Description = 'Shift Manager Factory Configuration', @Data = '<Tenaris.Manager.Shift.ShiftManager factoryType="Tenaris.Manager.Shift.Factory, Tenaris.Manager.Shift" isSingleton="True" />', @TypeName = 'Tenaris.Library.Framework.Factory.FactoryConfiguration, Tenaris.Library.Framework', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'ShiftMgr.Local', @Name = 'Tenaris.Manager.Shift.ShiftManager.Local', @Description = 'Shift Manager Local Proxy', @Data = '<Tenaris.Manager.Shift.ShiftManager url="tcp://localhost:49103/Tenaris.Manager.Shift.ShiftManager.soap" 
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'ShiftMgr.Proxy', @Name = 'Tenaris.Manager.Shift.ShiftManager.Proxy', @Description = 'Shift Manager Proxy', @Data = '<Tenaris.Manager.Shift.ShiftManager url="tcp://127.0.0.1:49103/Tenaris.Manager.Shift.ShiftManager.soap" 
		instanceType="Tenaris.Manager.Shift.Shared.IShiftManager, Tenaris.Manager.Shift.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
    	<Redundancy>      
     	 	<Address url="tcp://127.0.0.1:49103/Tenaris.Manager.Shift.ShiftManager.soap" forumPresent="false" isTargetManager="true"/>
    	</Redundancy>
  </Tenaris.Manager.Shift.ShiftManager>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'SpecService', @Name = 'Tenaris.Service.SpecificationManager', @Description = 'Specification Service Manager', @Data = '<Tenaris.Service.SpecificationManager factoryType="Tenaris.Service.Specification.SpecificationManagerFactory, Tenaris.Service.Specification.Manager" isSingleton="True">
...
', @TypeName = 'Tenaris.Library.Framework.Factory.FactoryConfiguration, Tenaris.Library.Framework', @Active = True;
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'SpecService.Client.Proxy', @Name = 'SpecificationServiceClient.Proxy', @Description = 'Specification Client Proxy', @Data = '<SpecificationServiceClient factoryType="Tenaris.Service.Specification.Client.SpecificationServiceClientFactory, Tenaris.Service.Specification.Client" isSingleton="True">
	<SpecificationServiceClientConfiguration managerConfig="Tenaris.Manager.Specification.Proxy"/>
</SpecificationServiceClient>', @TypeName = 'Tenaris.Library.Framework.Factory.FactoryConfiguration, Tenaris.Library.Framework', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'SpecServiceManager.Local', @Name = 'Tenaris.Manager.Specification.Local', @Description = 'Specification Service Manager Local Proxy', @Data = '<Tenaris.Manager.Specification.Local url="tcp://localhost:49105/Tenaris.Service.Specification.SpecificationManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'SpecServiceManager.Proxy', @Name = 'Tenaris.Manager.Specification.Proxy', @Description = 'Specification Service Manager Proxy', @Data = '<Tenaris.Manager.Specification.Proxy url="tcp://127.0.0.1:49105/Tenaris.Service.Specification.SpecificationManager.soap"
        instanceType="Tenaris.Service.Specification.Shared.ISpecificationManager, Tenaris.Service.Specification.Shared"
    	aliveInterval="1000"
		singleInstance="true" 
		isSingleton="true"     
    	...
    	validateConnection="false">
        <Redundancy>
        	<Address url="tcp://127.0.0.1:49105/Tenaris.Service.Specification.SpecificationManager.soap" forumPresent="false" isTargetManager="true"/>
        </Redundancy>
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = 'ALL', @MachineCode = null, @Code = 'TdaChart', @Name = 'TdaChartConfiguration', @Description = 'Tda Chart', @Data = '<TdaChartConfiguration
    refreshTime="100"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'TdaMgr.Proxy', @Name = 'Tenaris.Manager.Tda.TdaManager.Proxy', @Description = 'Tda Manager Proxy', @Data = '<Tenaris.Manager.Tda.TdaManager url="tcp://127.0.0.1:49113/Tenaris.Manager.Tda.TdaManager.soap"
		instanceType="Tenaris.Manager.Tda.Shared.ITdaManager, Tenaris.Manager.Tda.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
    	<Redundancy>      
      		<Address url="tcp://127.0.0.1:49113/Tenaris.Manager.Tda.TdaManager.soap" forumPresent="false" isTargetManager="true"/>
    	</Redundancy>
</Tenaris.Manager.Tda.TdaManager>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'TdaView', @AreaCode = 'TT3', @ZoneCode = 'ALL', @MachineCode = null, @Code = 'TdaView', @Name = 'CustomViewConfiguration', @Description = 'Tda Manager View', @Data = '<CustomViewConfiguration TdaManagerSectionName="Tenaris.Manager.Tda.TdaManager.Proxy"
...
', @TypeName = null, @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'TrackingManager.DBStatusChangePlugin', @Name = 'TrackingManager.DBStatusChangePlugin', @Description = 'Tracking Manager - DB Status Change Plugin', @Data = '<TrackingManager.DBStatusChangePlugin factoryType="Tenaris.Manager.Tracking.Plugin.Shared.DBStatusChangePluginFactory, Tenaris.Manager.Tracking.Plugin.Shared" isSingleton="True">
	<DBStatusChangePluginConfiguration DatabaseConnectionStringName="dbLevel2" />
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'TrackingManager.DefaultStatusChangePlugin', @Name = 'TrackingManager.DefaultStatusChangePlugin', @Description = 'Tracking Manager - Default Status Change Plugin', @Data = '<TrackingManager.DefaultStatusChangePlugin factoryType="Tenaris.Manager.Tracking.Plugin.Shared.DefaultStatusChangePluginFactory, Tenaris.Manager.Tracking.Plugin.Shared" isSingleton="True">
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'TrackingMgr', @Name = 'Tenaris.Manager.Tracking.TrackingManager', @Description = 'Tracking Manager Factory Configuration', @Data = '<Tenaris.Manager.Tracking.TrackingManager factoryType="Tenaris.Manager.Tracking.TrackingManagerFactory, Tenaris.Manager.Tracking" isSingleton="True">
<TrackingManagerConfiguration handshakeExecutionTimeout="0" 
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'TrackingMgr.Local', @Name = 'Tenaris.Manager.Tracking.TrackingManager.Local', @Description = 'Tracking Manager Local Proxy', @Data = '<Tenaris.Manager.Tracking.TrackingManager url="tcp://localhost:49107/Tenaris.Manager.Tracking.TrackingManager.soap"
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = null, @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'TrackingMgr.Proxy', @Name = 'Tenaris.Manager.Tracking.TrackingManager.Proxy', @Description = 'Tracking Manager Proxy', @Data = '<Tenaris.Manager.Tracking.TrackingManager url="tcp://127.0.0.1:49107/Tenaris.Manager.Tracking.TrackingManager.soap"
		instanceType="Tenaris.Manager.Tracking.Shared.ITrackingManager, Tenaris.Manager.Tracking.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
        ...
        validateConnection="false">
		<Redundancy>	
			<Address url="tcp://127.0.0.1:49107/Tenaris.Manager.Tracking.TrackingManager.soap" forumPresent="false" isTargetManager="true"/>
		</Redundancy>
</Tenaris.Manager.Tracking.TrackingManager>', @TypeName = 'Tenaris.Library.Proxy.Factories.GenericProxyFactoryConfigurationSection, Tenaris.Library.Proxy', @Active = True;
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'TrackingView', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'TrackingView', @Name = 'CustomViewConfiguration', @Description = 'Tracking Manager View', @Data = '<CustomViewConfiguration
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'MessageView', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'Message.Plugin', @Name = 'Message.Plugin', @Description = 'MessageManager - Desktop plugin configuration', @Data = '<MessagesDesktopPlugin 
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'MessageManager', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'MessgaeMgr.Local', @Name = 'Tenaris.Manager.Message.MessageManager.Local', @Description = 'Message Manager Local Proxy', @Data = '<Tenaris.Manager.Message.MessageManager url="tcp://localhost:49115/Tenaris.Manager.Message.MessageManager.soap" 
    ...
    EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'MessageManager', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'MessgaeMgr.Proxy', @Name = 'Tenaris.Manager.Message.MessageManager.Proxy', @Description = 'Message Manager Remote Proxy', @Data = '<Tenaris.Manager.Message.MessageManager url="tcp://127.0.0.1:49115/Tenaris.Manager.Message.MessageManager.soap" 
		instanceType="Tenaris.Manager.Message.Shared.IMessageManager, Tenaris.Manager.Message.Shared"
        aliveInterval="1000" 
        singleInstance="true" 
        isSingleton="true" 
	...
	EXEC [Configuration].[DoConfigDefineConfiguration] @UserIdentification = null, @ApplicationCode = 'MessageManager', @AreaCode = 'TT3', @ZoneCode = null, @MachineCode = null, @Code = 'MessageManager', @Name = 'Tenaris.Manager.Message.MessageManager', @Description = 'MessageManager Factory Configuration', @Data = '<Tenaris.Manager.Message factoryType="Tenaris.Manager.Message.MessageManagerFactory, Tenaris.Manager.Message" isSingleton="True">
