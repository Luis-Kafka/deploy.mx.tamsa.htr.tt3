...
BEGIN TRY
    ...
    EXEC [Specification].[DoConfigDefineSpecificationType] @Code = '$MILL', @Name = '$MILL', @Description = '$MILL', @Active = True;
    ...
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'SourceWorkorder', @Code = 'SourceWorkorder', @Name = 'SourceWorkorder', @Description = 'SourceWorkorder', @Active = True;
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'TargetWorkorder', @Code = 'TargetWorkorder', @Name = 'TargetWorkorder', @Description = 'TargetWorkorder', @Active = True;
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'SourceProduct', @Code = 'SourceProduct', @Name = 'SourceProduct', @Description = 'SourceProduct', @Active = True;
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'TargetProduct', @Code = 'TargetProduct', @Name = 'TargetProduct', @Description = 'TargetProduct', @Active = True;
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'Heat', @Code = 'Heat', @Name = 'Heat', @Description = 'Heat', @Active = True;
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'Lot', @Code = 'Lot', @Name = 'Lot', @Description = 'Lot', @Active = True;
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'Batch', @Code = 'Batch', @Name = 'Batch', @Description = 'Batch', @Active = True;
    EXEC [Specification].[DoConfigDefineComponentSubType] @SpecificationTypeCode = '$MILL', @ComponentTypeCode = 'MACHINEWORKFLOW', @Code = 'MACHINEWORKFLOW', @Name = 'MACHINEWORKFLOW', @Description = 'MACHINEWORKFLOW', @Active = True;
