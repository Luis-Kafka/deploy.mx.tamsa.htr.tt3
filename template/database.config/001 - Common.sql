...
BEGIN TRY
    ...
    EXEC [Common].[DoConfigDefineCenter] @Code = '$CENTER_CODE', @Name = '$CENTER_CODE', @Description = '$CENTER_CODE', @Active = True;
    ...
    EXEC [Common].[DoConfigDefineProcess] @Code = '$PROCESS_CODE', @Name = '$PROCESS_CODE', @Description = '$PROCESS_CODE', @BySide = False,  @Active = True;
    ...
    EXEC [Common].[DoConfigDefineArea] @CenterCode = '$CENTER_CODE', @Code = '$AREA_CODE', @Name = '$AREA_CODE', @Description = '$AREA_CODE', @Active = True;
    ...
    EXEC [Common].[DoConfigDefineMachine] @AreaCode = '$AREA_CODE', @ProcessCode = '$PROCESS_CODE', @MachineParentCode = null, @PlcCode = 1, @Code = '$MACHINE_CODE', @Name = '$MACHINE_CODE', @Description = '$MACHINE_CODE', @SortOrder = 1, @Active = True;
    ...
    EXEC [Common].[DoConfigDefineMachineWorkflowSequence] @MachineWorkflowCode = 'ALL', @MachineCode = '$MACHINE_CODE', @MachinePreviousCode = null, @Active = True;
	...
	EXEC [Common].[DoConfigDefineProductWorkflowProcess] @ProductWorkflowCode = 'ALL', @ProcessCode = '$PROCESS_CODE', @ItemSideCode = null, @IsOptional = False, @Active = True;
    ...
    EXEC [Common].[DoConfigDefineZoneDetail] @ZoneCode = 'ALL', @MachineCode = '$MACHINE_CODE', @Active = True;
