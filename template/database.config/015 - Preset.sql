...
BEGIN TRY
    ...
    -- EXEC [Preset].[DoConfigDefineMachine] @MachineCode = '$MACHINE_CODE', @SortOrder = 1, @CommandCode = null, @Active = True;
    ...
    -- EXEC [Preset].[DoConfigDefineMachineComponent] @MachineMachineCode = '$MACHINE_CODE', @Code = '$MACHINE_CODE', @Name = '$MACHINE_CODE', @Description = '$MACHINE_CODE', @SortOrder = 3, @idCommand = null, @Active = True;
