...
BEGIN TRY
    ...
    EXEC [Interruption].[DoConfigDefineGroup] @Code = '$MACHINE_CODE', @Name = '$MACHINE_CODE', @Description = '$MACHINE_CODE', @Active = True;
    ...
    EXEC [Interruption].[DoConfigDefineMachine] @MachineCode = '$MACHINE_CODE', @GroupCode = '$MACHINE_CODE', @CriticalMachineMachineCode=NULL, @Active = True;
    ...
    EXEC [Interruption].[DoConfigDefineStage] @StageCode = '$AREA_CODE', @CodeCode = '0', @Active = True;
    ...
    EXEC [Interruption].[DoConfigDefineCategoryMachine] @CategoryCode = 'INTERRUPTION', @MachineMachineCode = '$MACHINE_CODE', @Threshold = 120, @IsPercentage = False, @Active = True;
    EXEC [Interruption].[DoConfigDefineCategoryMachine] @CategoryCode = 'MICRO', @MachineMachineCode = '$MACHINE_CODE', @Threshold = 10, @IsPercentage = False, @Active = True;
	...
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '0', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '1', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '2', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '3', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '4', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '5', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '6', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '7', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '8', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '9', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '10', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '11', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '12', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '13', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '14', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '15', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '16', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '17', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '18', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '19', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '21', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '22', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '23', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '24', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '25', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '26', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '27', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '28', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '29', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '30', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '31', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '32', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '33', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '34', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '35', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '36', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '37', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '51', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '52', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '53', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '54', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '55', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '56', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '57', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '58', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '59', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '60', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '61', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
	EXEC [Interruption].[DoConfigDefineCodeMachine] @CodeCode = '62', @MachineMachineCode = '$MACHINE_CODE', @Active = True;
